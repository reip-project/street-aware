...
def analyze_timestamps(ts, title, fps, n=10, bins=1000, debug=True, verbose=False, plot=True, savefigs=None):
    ...
    if plot:
        ...
        if savefigs is not None:
            plt.savefig(savefigs + "timeline.png", dpi=120)
        ...
        if savefigs is not None:
            plt.savefig(savefigs + "periods_hist.png", dpi=120)
        ...
        if savefigs is not None:
            plt.savefig(savefigs + "periods_all.png", dpi=120)
        ...
        if savefigs is not None:
            plt.savefig(savefigs + "delays.png", dpi=120)
...
if __name__ == "__main__":
    path = "/mnt/tmp/nec/Aug_2/session_3/"
